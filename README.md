...
widget in the right section by default.

You can also press **Super+Space**, open **Setup → Plugins → Add**, paste the
repository URL, confirm, and enable the plugin.

## Use

- Left click the lotus: open or close the Stuti
...
```bash
omarchy plugin update krish.linga-bhairavi-stuti
omarchy plugin remove krish.linga-bhairavi-stuti
```
...
Plugin code is MIT-licensed. The user-supplied devotional transcription is not
covered by the software license; any rights remain with their respective holder.
